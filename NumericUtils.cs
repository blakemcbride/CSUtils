...
namespace ADOTest {
	...
	public static class NumericUtils {
		...
		private static char[] alpha = "0123456789abcdefghijklmnopqrstuvwxyz".ToCharArray();
	    ...
	    /// <returns>the formatted string<c>/returns>
		///<example><p>
	    ///	example:<br><br>
		...
		///<example><p>
		///	example:<br><br>
		///		string r = Format(-12345.348, 10, "CP", 12, 2);<br><br>
		///
		///		result in r:&nbsp;&nbsp;&nbsp;"(12,345.35)"
		/// </p></example>
